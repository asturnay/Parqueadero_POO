...
public class Modelo_UbicacnionVehiculo {
    ...
    public Modelo_UbicacnionVehiculo(String Ubi, boolean ubiDis, Vehiculo vehi, LocalDateTime Hoin /*LocalDate HoSal*/){
        this.Ubicacion = Ubi;
        this.Ubi_Disponible = ubiDis;
        this.vehiculo = vehi;         
        this.hora_ingreso = Hoin;
    }
    // Métodos set para Modelo_UbicacionVehiculo
    ...
    // Métodos get para Modelo_UbicacionVehiculo
